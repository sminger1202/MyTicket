...
//		DeviceInfo.IMSI = Util.URLEncoder(tm.getSimSerialNumber());
    ...
    private static String getUUID() {
        try {
            ...
            TelephonyManager tm = (TelephonyManager) TicketApplication.context.getSystemService(Context.TELEPHONY_SERVICE);
            tmDevice = tm.getDeviceId();
            tmSerial = tm.getSimSerialNumber();
            androidId = android.provider.Settings.Secure.getString(TicketApplication.context.getContentResolver(), android.provider.Settings.Secure.ANDROID_ID);
